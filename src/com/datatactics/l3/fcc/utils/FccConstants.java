...
public interface FccConstants {
    ...
    public final String MYSQL_PASSWORD      = "mysql.password";
    public final String MYSQL_SERVER        = "mysql.server";
    public final String MYSQL_PORT          = "mysql.port";
    public final String MYSQL_DATABASE      = "mysql.database";
}

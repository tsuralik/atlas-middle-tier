...
export BOOTSTRAP_CONFDIR="/var/solr/conf";
export ZK_HOST="127.0.0.1:2181";

export DATA_DIR="/var/solr/FCC/${COLLECTION_CONFIGNAME}/data";
export SHARD_DIR_NAME="SHARD";
export LOGS_DIR="/var/solr/FCC/${COLLECTION_CONFIGNAME}/logs/"
